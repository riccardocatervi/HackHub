...
public class HackathonSubmissionDTO {
    ...
    public void setIdGiudice(UUID idGiudice) {
        this.idGiudice = idGiudice;
    }

    public void setIdsMentori(List<UUID> idsMentori) {
        this.idsMentori = idsMentori;
    }
    ...
    public void setLuogo(Address luogo) {
        this.luogo = luogo;
    }
    ...
    public void setScadenzaIscrizioni(LocalDateTime v) {
        this.scadenzaIscrizioni = v;
    }

    public void setScadenzaSottomissioni(LocalDateTime v) {
        this.scadenzaSottomissioni = v;
    }
}
